	...
	function show(res){
		...
		for(var i=1;i<res.length;i++){
			...
			if(map['MEM_NO'] != ${sessionScope.memNo}){
				...
				var a1 = $('<a class="btn btn-theme02"><i class="fas fa-history"></i>복직</a>').attr("href", "<c:url value='/member/memberReInstate.do?memNo="+map["MEM_NO"] +"'/>");
				var tdEl6 = $('<td></td>').html(a1);
...
<section id="main-content">
	...
	<h3><i class="fas fa-users"></i> 퇴사자 목록</h3>
	<div class="row">
		<div class="col-lg-12">
			...
			<form name="frmList" action="<c:url value='/member/memberResignList.do'/>" method="post">
			...
			<div id="page">
				...
				<input type="button" id="register" value="사원 목록" class="btn btn-info" onclick="location.href='<c:url value='/member/memberList.do'/>'">
			</div>
		</div>
	</div>
	</section>
