...
/**
     ...
     * @param bean 검색조건
     */
    public void setSearchVO(ResSearchVO bean){
	...
	public String toString() {
		return "ResSearchVO [searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", searchUseYn="
				...
				+ recordCountPerPage + ", totalCount=" + totalCount + "]";
	}
