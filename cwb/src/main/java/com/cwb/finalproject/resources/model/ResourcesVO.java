...
public class ResourcesVO {
	...
	public String toString() {
		return "ResourcesVO [res_No=" + res_No + ", typeNo=" + typeNo + ", resName=" + resName + ", resPrice="
				+ resPrice + ", resRegdate=" + resRegdate + ", resLocation=" + resLocation + ", resInformation="
				+ resInformation + ", apprFlag=" + apprFlag + ", reservFlag=" + reservFlag + ", resFilename="
				+ resFilename + ", resFilesize=" + resFilesize + ", resOriginalfilename=" + resOriginalfilename + "]";
	}
